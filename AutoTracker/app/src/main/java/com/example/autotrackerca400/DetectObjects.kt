 ...
 * <p>
 * - setups model for object detection.
 * </p><p>
 * - Based on ; https://www.tensorflow.org/lite/android/tutorials/object_detection
 *</p>
 */
...
class DetectObjects(
    ...
    private fun setupObjectDetector() {
        // set score treshold, max amount of objects detected
        val optionsBuilder =
        ...
        val modelName =
            when (currentModel) {
                MODEL_EFFICIENTDETV0 -> "VehicleDetection.tflite"
